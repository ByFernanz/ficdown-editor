	...
	for(var i = startPoint.line; i <= endPoint.line; i++) {
		(function(i) {
			...
			if(direction !== undefined) {
				...
				} else if(currHeadingLevel == 3 && direction == "smaller") {
					text = text.substr(4);
...
SimpleMDE.prototype.autosave = function() {
	if(isLocalStorageAvailable()) {
		...
		if(el != null && el != undefined && el != "") {
			...
			el.innerHTML = "Autoguardado: " + h + ":" + m + " " + dd;
		}
...
SimpleMDE.toggleComment = toggleComment;
...
SimpleMDE.prototype.toggleComment = function() {
	toggleComment(this);
};
...
function saveTextAsFile(){
    textToWrite=simplemde.value();
    fileNameToSaveAs="story.md";
    ...
    var output = '';
    var selectedText = cm.getSelection();
    var text = selectedText || '    // Escribe tu código aquí';
...
function toggleCondition(editor) {
...
function toggleAumentar(){
  ...
  $('.CodeMirror-sizer').css({'margin-left': size});*/
